            ...
            <div>
              {sec.items.map((it) => (
                <NavLink
                  ...
                  onClick={onNavigate}
                  className={({ isActive }) =>
                    `relative block border-l px-3 py-2 text-sm transition ${
                      isActive ? 'border-slate-950 bg-white text-slate-950' : 'border-transparent text-slate-600 hover:border-slate-300 hover:bg-white/60 hover:text-slate-950'
                    }`
                  }
                >
                  {({ isActive }) => (
