...
// Tooltip for the per-election margin/NOTA bars — names the winner + party so you
// can read who won each election straight off the chart.
function WinnerTooltip({ active, payload, valueLabel }) {
  if (!active || !payload?.length) return null;
