...
const COLUMNS = [
  ...
  { key: 'parlNo', label: 'PC No', type: 'number', required: true, placeholder: '29', short: true, min: 1 },
  { key: 'parlName', label: 'PC Name', type: 'text', required: true, placeholder: 'Nalanda' },
  { key: 'assemblyNo', label: 'AC No', type: 'number', required: true, placeholder: '172', short: true, min: 1 },
  { key: 'assemblyName', label: 'AC Name', type: 'text', required: true, placeholder: 'Biharsharif' },
